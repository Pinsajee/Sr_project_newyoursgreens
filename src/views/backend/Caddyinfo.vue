          ...
          >
            <template v-slot:top>
              <v-toolbar flat color="white">
                <v-toolbar-title>CADDY </v-toolbar-title>
...
lastnameRules:[v => !!v || 'lastname is required'],
      ...
      dialog: false,
        headers: [
        {
          ...
          align: 'start',
          sortable: false,
          value: 'infocaddy.code' ,
        },
        { text: 'Firstname', value: 'calories' },
        { text: 'lastname', value: 'fat' },
        { text: 'Nickname', value: 'carbs' },
        { text: 'tel', value: 'protein' },
